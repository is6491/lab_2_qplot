...
* Create a visualization using the `qplot` function in an R Markdown document. 
    * Use the provided template `lab_2_template.Rmd` if desired.
...
* Assignments that do not use `qplot` will recieve 0 points.
...
https://github.com/jeremydmorris/lab_2_qplot